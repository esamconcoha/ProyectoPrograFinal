...
public class VistaModificarRecursoController implements Initializable {

    @FXML
    private Button op3b1;
    ...
    public void closeWindows(){
         try {
           ...
           stage.show();
           Stage myStage = (Stage) this.op3b1.getScene().getWindow();//no se coloca close window ya que no es necesario
           myStage.close();
