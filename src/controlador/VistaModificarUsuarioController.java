...
// ID de los botones que existen el en fxml
 ...
 public void closeWindows(){
         try {
            FXMLLoader loader = new FXMLLoader (getClass().getResource("/vista/vistaUsuarios.fxml"));//se obtiene el archivo fxml del menú al que se enlazó la ventana
           ...
           stage.show();
           Stage myStage = (Stage) this.op2b1.getScene().getWindow();//no se coloca close window ya que no es necesario
           myStage.close();
