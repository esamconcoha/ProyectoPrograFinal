 ...
 * @author Elí
 */
public class VistaCrearCursoController implements Initializable {
    
// ID de los botones que existen el en fxml
    @FXML
    private Button op3a1;
    ...
    //se crea este metodo para la funcionalidad de cerrar una ventana y regresar al menú anterior, esto se enlaza con el menú al que se enlazó este archivo
     public void closeWindows(){
         try {
           ...
           stage.show();
           Stage myStage = (Stage) this.op3a1.getScene().getWindow();//no se coloca close window ya que no es necesario
           myStage.close();
